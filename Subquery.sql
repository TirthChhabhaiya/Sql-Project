...
#So we are using that subquery in the where statement and if we just highlight the subwuery and run.
-- it's basically a list we are selecting from in the outer query
